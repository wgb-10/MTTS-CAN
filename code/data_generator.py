...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, paths_of_videos, nframe_per_video, dim, batch_size=12, frame_depth=10,   # Init batch size to 12
    ...
    def __data_generation(self, list_video_temp):
        ...
        if self.temporal == 'TS_CAN':
            ...
            print(f'[DEBUG] appearance data: {apperance_data.shape}')
